...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			...
			ldi		r19,8
			call	T6963C_TextGoTo
			ldi		ZL,low(2*STR_IVC_STATUS)
			ldi		ZH,high(2*STR_IVC_STATUS)
			call	T6963C_WriteStringPgm
			; Установить координаты вывода
			ldi		r18,9
			ldi		r19,8
			call	T6963C_TextGoTo
			ldi		ZL,low(2*STR_IVC_S_MEASURE)
			ldi		ZH,high(2*STR_IVC_S_MEASURE)
			call	T6963C_WriteStringPgm
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
VAH_LOOP_DEC:
			...
			brsh	VAH_LOOP
VAH_LOOP_END:
			; Восстанавливаем значение ЦАП до серии измерений
			pop		r16
			sts		DAC_CH_B+1,r16
			pop		r16
			sts		DAC_CH_B+0,r16
...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			...
			ldi		r19,8
			call	T6963C_TextGoTo
			ldi		ZL,low(2*STR_IVC_S_TRANSMIT)
			ldi		ZH,high(2*STR_IVC_S_TRANSMIT)
			call	T6963C_WriteStringPgm
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
